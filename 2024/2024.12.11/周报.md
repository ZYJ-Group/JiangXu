...
![输入图片说明](/imgs/2024-12-09/7CCewpfE5ECJuNdZ.png)
 ...
 ***通道注意力模块***
 ...
 4. 相加 sigmoid形成权重
 ![输入图片说明](/imgs/2024-12-09/NbgyqCKG5rA4MvyH.png)

**空间注意力模块**==压缩通道的数量==强调特征图空间位置的重要性，而更好地捕获局部信息。
![输入图片说明](/imgs/2024-12-09/56f8XOK4BwRV4d5T.png)

 改进版
 ![输入图片说明](/imgs/2024-12-09/u5AEGMmR7hkGMgIR.png)
 ```py
import torch  
